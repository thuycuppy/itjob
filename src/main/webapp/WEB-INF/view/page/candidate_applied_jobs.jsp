                    ...
                    <div class="profile-nav">
                        <div class="panel">
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <a href="/candidate/profile"> <i class="fa fa-user"></i> Profile</a>
                                </li>
                                <li>
                                    <a href="/candidate/edit-profile"> <i class="fa fa-edit"></i> Edit Profile</a>
                                </li>
                                <li class="active">
                                    <a href="/candidate/applied-jobs"> <i class="fa fa-list-alt"></i> Jobs Applied</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="pagination-box clearfix">
                        <ul class="pagination">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a href="/candidate/applied-jobs?page=1"><span aria-hidden="true">«</span></a></li>
                                </c:otherwise>
                            </c:choose>
                            <c:forEach var="page" begin="${pagination.beginIndex}" end="${pagination.endIndex}">
                                <c:choose>
                                    <c:when test="${page == pagination.currentIndex}">
                                        <li class="active"><a href="/candidate/applied-jobs?page=${page}">${page}</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li><a href="/candidate/applied-jobs?page=${page}">${page}</a></li>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a href="/candidate/applied-jobs?page=${applications.totalPages}"><span aria-hidden="true">»</span></a></li>
                                </c:otherwise>
                            </c:choose>
                        </ul>
                    </div>
